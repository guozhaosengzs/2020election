...
pa_h_2012 <- pa_house %>% filter(Year == 2002 | Year == 2006)
...
pa <- ggplot() +
  geom_line(data = pa_h_2012, mapping = aes(x = factor(Year), y = RD_vote_r, group=1), color = "blue", size = 2) +
  geom_line(data = pa_h_2016, mapping = aes(x = factor(Year), y = RD_vote_r, group=1), color = "red", size = 2) +
  geom_line(data = pa_h_2020, mapping = aes(x = factor(Year), y = RD_vote_r, group=1), size = 1, linetype = "dotted", color = "blue") +
  geom_point(data = pa_house, mapping = aes(x = factor(Year), y = RD_vote_r, shape="House Election"), size = 5) +
  
  
  geom_line(data = pa_p_2012, mapping = aes(x = factor(Year), y = RD_vote_r, group=1), color = "blue", size = 2, linetype = "twodash") +
  geom_line(data = pa_p_2016, mapping = aes(x = factor(Year), y = RD_vote_r, group=1), color = "red", size = 2, linetype = "twodash") +
